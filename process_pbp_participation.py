...
class TransformPbPParticipation:
    ...
    def __init__(self, new_participation_file, today):
        #TODO: Create hist tables,  Add in these to the above parents, concat  play_hist_file, play_player_hist_file,
    ...
    def add_participation_to_play(self, df_play):
        ...
        # Read in the participation file and drop all rows with no players in the possesion team column
        ...
        # Save the table
        df_play_filtered.to_csv('./production_tables/play.csv', index=False)
        return df_play_plus
    ...
    def add_participation_to_play_player(self, df_play_plus, df_play_player):
        ...
        # Create a series that is a list of the offensive and defensive players from the columns that have them all together
        ...
        # Rename columns to prep for contatenating the tables
        ...
        df_play_player_no_role.to_csv('./production_tables/play_player_no_role.csv', index=False)
        ...
        df_play_player_plus.to_csv('./production_tables/play_player.csv', index=False)
